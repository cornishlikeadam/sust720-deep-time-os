...
```mermaid
flowchart TD
    subgraph Step1["Step 1: Epistemic & Temporal Grounding"]
        A1["Scientific Deep Time vs. Indigenous Relational Time"] --> A2["Bioregional Baseline Mapping (500 Years)"]
        A2 --> A3{{"Preserve-Human-Judgment: Ontological Framework Covenant"}}
        class A3 judgmentNode
    end

    subgraph Step2["Step 2: Superforecasting & Scenario Stress-Testing"]
        B1["Anti-Fragility Modeling (50-500 yrs)"] --> B2[["AI Insertion Point: Multi-Vector Ecological Perturbation Engine"]]
        B2 --> B3["Student Empirical Cross-Examination & Selection"]
        class B2 aiNode
    end

    subgraph Step3["Step 3: Regenerative System Design & AI Protocol"]
        C1["500-Year Ecological System Architecture"] --> C2["AI Application Specification & Boundary Rules"]
        C2 --> C3{{"Preserve-Human-Judgment: System Design & Ethical Boundaries"}}
        class C3 judgmentNode
    end

    subgraph Step4["Step 4: Co-Creation Workshop & Relational Stress-Testing"]
        D1["Embodied Studio Prototyping"] --> D2[["Non-Use Boundary: Live Peer, Elder & Inter-Species Critique"]]
        class D2 nonUseNode
    end

    subgraph Step5["Step 5: Capstone Synthesis & Moral Defense"]
        E1["Unified Blueprint & Generational Ethics Charter"] --> E2{{"Preserve-Human-Judgment: 7th-Gen Moral Defense & Final Grading"}}
        class E2 judgmentNode
    end

    Step1 --> Step2 --> Step3 --> Step4 --> Step5

    classDef judgmentNode fill:#4c1d95,stroke:#ffd700,stroke-width:2px,color:#fff;
    classDef aiNode fill:#0f766e,stroke:#ffd700,stroke-width:2px,color:#fff;
    classDef nonUseNode fill:#881337,stroke:#f43f5e,stroke-width:2px,color:#fff;
```
